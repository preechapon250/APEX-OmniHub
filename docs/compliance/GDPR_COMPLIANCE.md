...
## Data Categories
- Account data: email, profile metadata.
- Usage data: activity logs, device fingerprints (for zero-trust).
- Support data: tickets and incident notes.

## Lawful Bases
- Contract: providing the APEX/TradeLine 24/7 service.
- Legitimate interests: security monitoring, fraud prevention.
- Consent: optional marketing or beta programs.
